...
async function main() {
    ...
    const passAdmin = await bcryptjs_1.default.hash('admin123', 10);
    const passManager = await bcryptjs_1.default.hash('manager123', 10);
    const passIT = await bcryptjs_1.default.hash('it123', 10);
    const passUser = await bcryptjs_1.default.hash('user123', 10);
    ...
    const laptop1 = await prisma.asset.upsert({
        ...
        create: {
            ...
            assetType: client_1.AssetType.LAPTOP,
    ...
    const laptop3 = await prisma.asset.upsert({
        ...
        create: {
            ...
            manufacturer: 'Dell',
            model: 'Latitude 7440',
            status: client_1.AssetStatus.UNDER_REPAIR,
            condition: client_1.AssetCondition.FAIR,
            departmentId: deptIT.id,
            locationId: locHeadOffice.id,
    ...
    const monitor1 = await prisma.asset.upsert({
        ...
        create: {
            ...
            assetType: client_1.AssetType.MONITOR,
    ...
    const headset1 = await prisma.asset.upsert({
        ...
        create: {
            ...
            assetType: client_1.AssetType.HEADSET,
    ...
    await prisma.assetAssignment.create({
        data: {
            ...
            conditionAtAssignment: client_1.AssetCondition.EXCELLENT,
    ...
    const maint1 = await prisma.maintenanceRecord.create({
        data: {
            ...
            repairStatus: client_1.MaintenanceStatus.IN_PROGRESS,
    ...
    await prisma.assetStatusHistory.createMany({
        data: [
            {
                assetId: laptop1.id,
                action: client_1.AssetAction.CREATED,
                newStatus: client_1.AssetStatus.AVAILABLE,
                performedById: userAdminObj.id,
                remarks: 'Asset registered in system.',
            },
            {
                assetId: laptop1.id,
                action: client_1.AssetAction.ASSIGNED,
                previousStatus: client_1.AssetStatus.AVAILABLE,
                newStatus: client_1.AssetStatus.ASSIGNED,
            ...
            {
                assetId: laptop3.id,
                action: client_1.AssetAction.MAINTENANCE_STARTED,
                previousStatus: client_1.AssetStatus.AVAILABLE,
                newStatus: client_1.AssetStatus.UNDER_REPAIR,
