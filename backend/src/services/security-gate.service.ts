  ...
  public static async recordAssetOut(
    ...
    return await prisma.$transaction(async (tx) => {
      ...
      await HistoryService.recordEvent(tx, {
        ...
        previousAllocationStatus: asset.allocationStatus,
        newAllocationStatus: asset.allocationStatus,
        previousHolderId: asset.currentHolderId,
        newHolderId: asset.currentHolderId,
        ...
        relatedEntityType: 'GateMovement',
        relatedEntityId: movement.id,
        relatedRecordCode: movementCode,
        eventDate: now,
